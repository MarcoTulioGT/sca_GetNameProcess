  ...
  stages {
    ...
    stage('Test') {
      steps {
       ...
       sh 'ant curl -u admin:#jfrog17Tigo -X PUT "http://172.22.71.6:8081/artifactory/Tigo/tf/om/ic/DEV_Testplan/GetNameProcessCRM.html" -T $WORKSPACE/DEV_Testplan/*.html'
      }
    }
    stage('Artefactory') {
      steps {
